...
///    	mNotifyCharacteristic.setValue(strValue.getBytes("EUR-KR"));
    ...
    public void writeCharacteristicsBytes(BluetoothGattCharacteristic characteristic, byte[] strValue) {
    	if (mBluetoothAdapter == null || mBluetoothGatt == null) {
    		Log.w(TAG, "BluetoothAdapter not initialized");
    		return;
    	}
		characteristic.setValue(strValue);
